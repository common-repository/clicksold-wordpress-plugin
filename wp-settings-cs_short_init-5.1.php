...
// CS - shortinit - disabled /**
// CS - shortinit - disabled  *  WordPress Locale Switcher object for switching locales.
// CS - shortinit - disabled  *
// CS - shortinit - disabled  * @since 4.7.0
// CS - shortinit - disabled  *
// CS - shortinit - disabled  * @global WP_Locale_Switcher $wp_locale_switcher WordPress locale switcher object.
// CS - shortinit - disabled  */
// CS - shortinit - disabled $GLOBALS['wp_locale_switcher'] = new WP_Locale_Switcher();
// CS - shortinit - disabled $GLOBALS['wp_locale_switcher']->init();
...
// CS - shortinit - disabled  * to load on the {@see 'init'} hook that follows (e.g. widgets), and many plugins instantiate
// CS - shortinit - disabled  * themselves on it for all sorts of reasons (e.g. they need a user, a taxonomy, etc.).
// CS - shortinit - disabled  *
// CS - shortinit - disabled  * If you wish to plug an action once WP is loaded, use the {@see 'wp_loaded'} hook below.
// CS - shortinit - disabled  *
// CS - shortinit - disabled  * @since 1.5.0
// CS - shortinit - disabled  */
