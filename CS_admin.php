...
*/
		...
		function cs_add_custom_dashboard_widget() {
			...
			$a_widget = new CS_Widget(null, null, null);		// Dashboard widget css is part of the package of all css for widgets so it's included by doing this call.
								...
								(function($){ 
									$(document).ready(function(){				 
										var csPopupHtml =	\"<div id=\\\"cs_upgrade_popup\\\" class='cs_upgrade_popup'>\" +
															...
															\"    <p>ClickSold offers a one month free trial on all our paid service tiers.</p>\" + 
															\"  </div>\" + 
